...
// current time if Date is unset and will use "Auto generated by 0987363/cobra"
...
func fillHeader(header *GenManHeader, name string) error {
	...
	if header.Source == "" {
		header.Source = "Auto generated by 0987363/cobra"
	}
	return nil
}
...
func genMan(cmd *cobra.Command, header *GenManHeader) []byte {
	...
	if !cmd.DisableAutoGenTag {
		buf.WriteString(fmt.Sprintf("# HISTORY\n%s Auto generated by 0987363/cobra\n", header.Date.Format("2-Jan-2006")))
	}
	return buf.Bytes()
}
